...
const CreateAccount = ({setIsCreateAccountOpen}) => {
  return (
    <div className="bg-black/60 flex items-center justify-center z-10 fixed top-0 left-0 h-screen w-screen">
          <div
            id="signup"
            className="lg:w-[50%] h-[55%] w-full -translate-y-10 bg-white rounded-md relative"
          >
            <button
            ...
            <div className='h-full'>
              <div className='bg-green-200/50 py-3 hidden lg:flex px-24 rounded-t-md text-center font-medium'>
              ...
              <div className='flex items-center justify-between px-5 lg:px-10 py-3'>
                ...
                <p className='text-sm font-medium hidden lg:flex text-gray-500'>Already have an account? <span className='text-blue-600'>Sign In</span></p>
              </div>
              <div className='flex items-start w-full gap-5'>
                <div className='lg:w-1/2 w-full px-5 lg:px-16 rounded flex flex-col items-center gap-4'>
                  ...
                  <div className='flex justify-between w-full items-center'>
                    <button className='px-5 py-2 rounded-full bg-blue-600 text-white font-bold text-lg w-1/2 lg:w-full'>Create Account</button>
                    <span className='text-blue-600 flex lg:hidden'>or, Sign In</span>
                  </div>
                  ...
                  <p className='text-sm text-center flex lg:hidden text-gray-500 font-light'>By signing up, you agree to our Terms & conditions, Privacy policy</p>
                </div>
