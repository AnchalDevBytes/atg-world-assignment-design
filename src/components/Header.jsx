...
const Header = () => {
  ...
  return (
    <nav className="flex justify-between px-10 py-4 items-center shadow-md">
      <div className="flex items-center">
        <h2 className="text-green-400 text-2xl font-light">
          ATG.<span className="text-gray-600">W</span>
        </h2>
        <img src="/assets/logo.png" alt="logo" />
        <h2 className="text-gray-600 text-2xl font-light">RLD</h2>
      </div>
      ...
      <div className="flex items-center gap-1">
        <p className="text-base font-normal">Create account.</p>
        <div
          onClick={handleAuthOptionClick}
          className="flex items-center px-5 py-2 rounded-md hover:bg-gray-200 active:bg-gray-300 transition-all duration-200 cursor-pointer relative"
        >
